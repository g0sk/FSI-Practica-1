...
def tree_search(problem, fringe, nombre):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "nodos expandidos por",nombre, "es: ",count
            return node
...
def graph_search(problem, fringe, nombre):
    """Search through the successors of a problem to find a goal.
    The argument fringe should be an empty queue.
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "nodos expandido  por", nombre, "es: ", count
            return node
...
def breadth_first_graph_search(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return graph_search(problem, FIFOQueue(),"amplitud")  # FIFOQueue -> fringe

def ramificacion_graph_search(problem):

    return tree_search(problem, RamQueue(),"ramificacion")

def ramificacion_su_graph_search(problem):

    return tree_search(problem, RamSubestQueue(problem),"ramificacion y acotacion")

def depth_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Stack(),"profundidad")
